...
export SPARK_CLASSPATH="/root/ephemeral-hdfs/share/hadoop/hdfs/lib/aws-java-sdk-1.7.4.jar:/root/ephemeral-hdfs/share/hadoop/hdfs/lib/hadoop-aws-2.7.0.jar:$SPARK_CLASSPATH"
...
if [[ -f "$ALLUXIO_CLIENT_JAR" ]] ; then
    export SPARK_CLASSPATH="$ALLUXIO_CLIENT_JAR:$SPARK_CLASSPATH"
fi
